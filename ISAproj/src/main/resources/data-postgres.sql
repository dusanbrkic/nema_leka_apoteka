...
insert into dermatolog (id, username, password, ime, prezime, email_adresa, token, first_login, adresa, grad, drzava, broj_telefona,prosecna_ocena) values (nextval('korisnik_seq'), 'dusan1', 'dusan1', 'Dusan', 'Brkic', 'dusanbrk1@gmail.com', 'dusan1-dusan1', false, 'Alekse Santica 14', 'Novi Sad', 'Kraljevina Srbija', '0640857676','4.5');
